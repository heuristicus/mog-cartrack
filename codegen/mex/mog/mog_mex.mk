START_DIR = C:\Users\Carlos\DOCUME~1\GitHub\MOG-CA~1
...
SYS_INCLUDE += /I "$(START_DIR)\codegen\mex\mog"
...
%.$(OBJEXT) : $(START_DIR)\codegen\mex\mog/%.c
	$(CC) $(CFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)\codegen\mex\mog/%.cpp
	$(CC) $(CPPFLAGS) "$<"
